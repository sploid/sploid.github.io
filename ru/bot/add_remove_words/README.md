...
Всем привет, довольно часто уже существующие словари не подходят и хочется добавлить свои слова.
В этом случае можно воспользоваться возможностью редактирования слов, которая реализована с помощью нескольких команд,
который описаны ниже.
